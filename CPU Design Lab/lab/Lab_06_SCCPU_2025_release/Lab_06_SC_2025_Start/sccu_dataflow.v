...
module sccu_dataflow(op, func, z, wmem, wreg, regrt, m2reg , aluc , shift ,
    ...
    assign wreg =      i_add  | i_sub  | i_and | i_or   | i_xor | i_sll | i_srl | i_sra |
                       i_addi | i_andi | i_ori | i_xori | i_lw  | i_lui | i_jal |i_subu | 
							  i_addu | i_slt | i_sltu | i_sllv | i_srlv | i_srav |i_addiu | i_slti|
							  i_sltiu;   
    ...
    assign aluimm =    i_addi | i_andi | i_ori | i_xori | i_lw  | i_lui | i_sw | i_addiu | i_slti | i_sltiu;
    assign sext   =    i_addi | i_lw   | i_sw  | i_beq  | i_bne | i_addiu | i_slti | i_sltiu;
    assign aluc[3] =   i_sra | i_slt | i_sltu | i_sllv | i_srlv | i_srav | i_slti | i_sltiu;
    assign aluc[2] =   i_sub  | i_or   | i_srl | i_sra  | i_ori  | i_lui | i_subu | i_srlv | i_srav ;
    assign aluc[1] =   i_xor  | i_sll  | i_srl | i_sra  | i_xori | i_beq  | i_bne | i_lui | i_sltu | i_sllv | i_srav | i_sltiu;
    assign aluc[0] =   i_and  | i_or   | i_sll | i_srl  | i_sra  | i_andi | i_ori | i_slt | i_sllv | i_srav | i_slti ; 
