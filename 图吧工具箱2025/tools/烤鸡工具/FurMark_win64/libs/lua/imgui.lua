...
ImGuiTreeNodeFlags_SpanTextWidth        = 8192 -- NEW in ImGui 1.90.9 - Narrow hit box + narrow hovering highlight, will only cover the label text.
...
ImGuiSelectableFlags_AllowItemOverlap   = 16 --  // (WIP) Hit testing to allow subsequent widgets to overlap this one
